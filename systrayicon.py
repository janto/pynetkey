...
def password_dialog():
	...
	template = [
		...
		[130, "This program was not made by IT and is not supported by IT! -jantod@gmail.com", -1, (7, line(0), 150, 30), 0x50000000, 0],
		[130, 'Username:', -1, (7, line(1), 43, 10), 0x50000000, 0],
		[129, '', 1000, (59, line(1)-2, 59, 14), 0x50810080, 0],
		[130, 'Password:', -1, (7, line(2), 43, 10), 0x50000000, 0],
		[129, '', 1001, (59, line(2)-2, 60, 15), 0x50810080|win32con.ES_PASSWORD, 0],
		[128, 'OK', 1, (59, line(3), 50, 14), 0x50010001, 0],
	]
	data = {}
